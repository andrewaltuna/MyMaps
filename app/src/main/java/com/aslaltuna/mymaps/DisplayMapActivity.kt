...
import com.aslaltuna.mymaps.databinding.ActivityDisplayMapBinding
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val boundsBuilder = LatLngBounds.Builder()
         for (place in userMap.places) {
             ...
             mMap.addMarker(MarkerOptions().position(LatLong).title(place.title).snippet(place.description))
         }
